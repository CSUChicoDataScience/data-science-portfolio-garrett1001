...
* `sex` - `character` - a categorical variable for the sex of the patient. (male; female)
...
* `target` - `character` - diagnosis of heart disease (healthy = no disease; unhealthy = disease)
